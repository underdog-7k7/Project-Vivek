  ...
  return (
    <div className="relative min-h-screen bg-background flex items-center justify-center p-4 md:p-8 manuscript-bg">
      <div className="w-full max-w-5xl grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div className="animate-in-slide-right hidden md:block">
          <div className="bg-card rounded-2xl p-8 md:p-12 shadow-lg border border-border">
            {/* Decorative Element */}
            <div className="mb-8 flex justify-center">
              <div className="w-40 h-40 bg-gradient-to-br from-primary/20 via-accent/10 to-primary/10 rounded-xl flex items-center justify-center border-2 border-primary/30">
                <svg
                  ...
                  strokeWidth="1.5"
                >
                  {/* Stylized Garuda/Phoenix inspired icon */}
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed text-base">
                ...
                It deals with various aspects of life,
                death, and afterlife, cosmology and others offering insights and spiritual
                guidance.
              </p>
              <br></br>
              <p className="text-muted-foreground leading-relaxed text-base">It is said to have 19,000 shlokas. However, the manuscripts that have survived into the modern era have preserved about 8,000 verses. The book which serves as the Knowledge source for this RAG is The book Garudapuranasaroddhara, translated by Ernest Wood and SV Subrahmanyam</p>
            </div>
          </div>
        </div>
      </div>
